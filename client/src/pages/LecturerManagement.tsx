...
const LecturerManagement: React.FC = () => {
    const [lecturers, setLecturers] = useState<Lecturer[]>([
        {
            id: 'd1',
            full_name: 'Dr. Ahmad Subarjo, M.Kom',
            nidn: '0712058501',
            email: 'ahmad.subarjo@univ.ac.id',
            role: 'lecturer',
            status: 'active',
        ...
        {
            id: 'd2',
            full_name: 'Ir. Budi Santoso, M.Kom',
            nidn: '0715017802',
            email: 'budi.santoso@univ.ac.id',
            role: 'lecturer',
            status: 'active',
            type: 'Dosen Mata Kuliah',
            sub_type: 'Koordinator Mata Kuliah',
            faculty: 'Fakultas Teknik (FT)'
        },
        {
            id: 'd3',
            full_name: 'Dr. Maria Ulfa, M.Psi',
            nidn: '0710038201',
            email: 'maria.ulfa@univ.ac.id',
            role: 'lecturer',
            status: 'active',
            type: 'Dosen Pembimbing',
            sub_type: 'Dosen Pembimbing Akademik (PA)',
            faculty: 'Fakultas Keguruan dan Ilmu Pendidikan (FKIP)'
        },
        {
            id: 'd4',
            full_name: 'Prof. Bambang Pamungkas, Dr.',
            nidn: '0711096501',
            email: 'bambang.p@univ.ac.id',
            role: 'lecturer',
            status: 'active',
            type: 'Dosen Pembimbing',
            sub_type: 'Dosen Pembimbing Skripsi',
            faculty: 'Fakultas Ekonomi dan Bisnis (FEB)'
        },
        {
            id: 'd5',
            full_name: 'Dr. Eng. Wahyudi, M.T',
            nidn: '0718028803',
            email: 'wahyudi.eng@univ.ac.id',
            role: 'lecturer',
            status: 'active',
            type: 'Dosen Mata Kuliah',
            sub_type: 'Dosen Pengampu Mata Kuliah',
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white dark:bg-slate-900 p-8 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-hidden group">
                ...
                <button className="relative z-10 flex items-center justify-center gap-3 px-6 py-4 bg-primary hover:bg-primary/90 text-white font-bold rounded-2xl shadow-xl shadow-primary/20 transition-all active:scale-95 text-sm uppercase tracking-wider">
                    <Plus size={20} />
                        ...
                        >
                            ...
                            <div className="space-y-4 pt-4 border-t border-slate-100 dark:border-slate-800/50">
                                ...
                                <div className="flex items-center gap-2 pt-2">
                                    <button className="flex-1 py-3 px-4 bg-slate-50 dark:bg-slate-800 hover:bg-primary hover:text-white text-slate-600 dark:text-slate-400 rounded-xl font-bold transition-all text-xs flex items-center justify-center gap-2 border border-slate-200/50 dark:border-slate-700/50 shadow-sm">
                                        <Edit2 size={14} />
                                        Detail
                                    </button>
                                    <button className="w-12 py-3 bg-red-500/5 hover:bg-red-500 hover:text-white text-red-500 rounded-xl transition-all border border-red-500/10 flex items-center justify-center">
                                        <Trash2 size={16} />
                                    </button>
                                </div>
                            </div>
